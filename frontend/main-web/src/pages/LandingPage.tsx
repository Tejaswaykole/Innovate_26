...
<img src="/logo.png" alt="Innovative'26 Logo" className="h-12 object-contain" />
</div>
...
<h1 className="text-on-surface text-5xl md:text-6xl font-black leading-tight tracking-tight font-display-lg">
                            INNOVATIVE'26: <br /><span className="text-primary">Build the Future</span>
</h1>
...
<span className="text-xl font-bold font-display-lg">INNOVATIVE'26</span>
</div>
...
<div className="pt-8 text-center text-white/40 text-xs">
                    © 2024 INNOVATIVE'26. All Rights Reserved. Built with passion for innovation.
                </div>
</div>
</footer>
</main>
